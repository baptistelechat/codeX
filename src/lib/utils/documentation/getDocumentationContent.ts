...
const getDocumentationContent = (
  ...
  if (documentation.documentationPage.url.includes("github.com")) {
    const nonce = getNonce();

    const url = documentation.documentationPage.url.split(
      "https://github.com/"
    );
        ...
        <div class="flex flex-col h-screen">
          ...
          <div class="flex items-center justify-center gap-4 border-t border-t-sky-200 p-2">
            ...
            <a
              ...
              href="${documentation.documentationPage.url}"
              target="_blank"
            >
    ...
    return html;
  } else if (documentation.documentationPage.canBeIframe) {
  ...
  // Fallback if documentation can't be added in iframe
  const html = `
    <!DOCTYPE html>
    <html lang="en">
      <head>
